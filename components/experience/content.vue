...
<template>
  <div class="content">
    <div class="d-flex align-items-center mb-2 flex-wrap">
      <img :src="experience.logo" alt="company-logo" class="logo-size mr-2" />
    ...
    <ul
      v-for="(experience, index) in experience.description"
      :key="index"
    >
      <li class="experience-description">{{ experience }}</li>
    </ul>
  </div>
</template>
